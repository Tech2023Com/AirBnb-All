...
router.post("/reservation",(req,res)=>{
    ...
    // }
    var data=[hotel.roomId, hotel.custId,hotel.bookingDate,hotel.startDate,hotel.endDate,hotel.amount,hotel.extra_matress]
    let sql = "INSERT INTO reservation(room_id,cust_id,booking_date,start_date,end_date,amount,extra_matress) VALUES( ?, ? ,?,?,?,?,?)";
